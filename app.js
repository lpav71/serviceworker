firebase.initializeApp({
    messagingSenderId: '912079911909'
});
...
function getToken() {
    messaging.requestPermission()
        .then(function() {
            // Получить идентификатор экземпляра токена. Первоначально это делает сетевой вызов, после извлечения
            // последующие вызовы getToken будут возвращены из кэша.
            messaging.getToken()
                .then(function(currentToken) {
                    if (currentToken) {
...
function sendNotification(notification) {
    var key = 'AAAA1Fwy--U:APA91bH1_Oi1T68zH_XC4bsNCR80OpH0ES5PqCAI6E9g01rGnttLtiTtXPbs09KBkp-ueogVJKhsRz2FYztBLI8FmXj3JNQSwM8aPio0xwvoP8sJKMGaK9yPTqLj1CW9R5UBq9gjH9if\n';
